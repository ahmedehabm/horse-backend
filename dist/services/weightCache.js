 ...
 */
export const weightCache = new LRUCache({
    max: 1000,
...
export function setWeight(thingName, weight) {
    weightCache.set(thingName, weight);
}
export function getWeight(thingName) {
    return weightCache.get(thingName) ?? null;
}
export function hasWeight(thingName) {
...
//   return things;
// }
//# sourceMappingURL=weightCache.js.map